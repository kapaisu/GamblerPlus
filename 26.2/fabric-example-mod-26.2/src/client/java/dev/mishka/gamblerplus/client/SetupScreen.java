...
public final class SetupScreen extends Screen {
	...
	public void extractRenderState(GuiGraphicsExtractor ctx, int mx, int my, float delta) {
		...
		ctx.text(font, title, cx - tw / 2, iy + ICON_SIZE + 10, Theme.TEXT, false);
		...
		ctx.text(font, sub, cx - sw / 2, iy + ICON_SIZE + 24, subColor, false);

		String hint = "you can always rebind in Options > Controls";
		int hw = font.width(hint);
		ctx.text(font, hint, cx - hw / 2, py + PANEL_H - 18, Theme.TEXT_DIM, false);
